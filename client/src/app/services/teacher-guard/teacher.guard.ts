...
export class TeacherGuard implements CanActivate {
  ...
  canActivate(
    ...
    if (this.instituteUser) {
      if (this.instituteUser.type === 'admin') return true;
      else if (this.instituteUser.type === 'teacher') {
        if (this.searchUser(this.clss.teacher, this.user)) return true;
      }
    }
